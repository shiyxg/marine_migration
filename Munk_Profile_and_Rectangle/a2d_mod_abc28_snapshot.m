...
hF = figure(gcf);
% filename = 'Seismic_Inversion_book_code_2.gif';
...
%         colormap(gray);
        ...
        title(figure_title);
        ylabel('Z (m)');xlabel('X (M)');caxis([-0.001 0.001]); 
%         ylabel('Z (m)');xlabel('X (M)');caxis([-0.1 0.1]); %pause(0.2);
        ...
        title(figure_title);
        ylabel('Time (s)');xlabel('g #');caxis([-0.001 0.001]); %pause(0.2);
%         ylabel('Time (s)');xlabel('g #');caxis([-0.1 0.1]); %pause(0.2);
